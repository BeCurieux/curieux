 ...
 *
 * It lived at `/` until there was anything to put there. The landing page has
 * the root now, and this kept its gate on the way to `/workbench`: a dev tool
 * that lists the local cache is no more appropriate one path down than it was
 * at the door.
 *

...
<<<<<<< Updated upstream
import { packSummary } from '../src/lib/compute.js'
=======
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
  bundles: db.bundles.map((b) => {
    ...
    return { id: b.id, code: b.code, tile: b.tile, name: b.name, itemCount: sm.itemCount, type: b.type, price: sm.price, attach: b.attach, status: b.status, statusKind: b.statusKind }
  }),
})

export const bundlesView = () => ({
  bundles: db.bundles.map((b) => ({ ...b, summary: packSummary(b, {}), availability: bundleAvailability(b) })),
=======
...
<<<<<<< Updated upstream
  return { ...b, components, summary: packSummary(b, {}), availability: bundleAvailability(b) }
=======

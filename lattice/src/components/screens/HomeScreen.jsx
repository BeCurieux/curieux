      ...
      <div style={{ display: 'flex', gap: 20, alignItems: 'flex-start' }}>
        ...
        <div style={{ flex: 1.7, minWidth: 0, ...panel }}>
          ...
          <div style={{ padding: '6px 10px' }}>
            {v.bundles.map((b) => (
<<<<<<< Updated upstream
              <div key={b.id} className="lt-nav" style={{ display: 'flex', alignItems: 'center', gap: 14, padding: '13px 12px', borderRadius: 11, cursor: 'pointer' }} onClick={() => v.openBundle(b.id)}>
=======
...
<<<<<<< Updated upstream
            {!v.hasBundleMatches && (
              <div style={{ padding: '26px 12px', textAlign: 'center', fontSize: 12.5, color: T.muted2 }}>
                No bundles match “{v.bundleQuery}”.
              </div>
            )}
=======
>>>>>>> Stashed changes

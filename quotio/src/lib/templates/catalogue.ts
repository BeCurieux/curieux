  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description: "Miles from the city center. Leave it at zero if you're local.",
        required: false,
...
const website = template(
  {
    ...
    type: "estimator",
    tagline: "Qualify leads before the discovery call.",
...
const skincare = template(
  {
    ...
    type: "quiz",
    tagline: "Send shoppers to the right product instead of the whole catalog.",

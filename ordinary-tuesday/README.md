# Ordinary Tuesday (working brand TBD)

> You live it. We help you keep it.

Ordinary Tuesday turns a parent's photographs, quotes and short memories about their
...
```bash
npm run seed     # creates demo@ordinarytuesday.test with Florence (age 2), 41 memories
